...
!  $Id: 4km-0.125.F90,v 1.1 2015/02/23 22:09:36 ytian Exp ytian $ 
!  Usage: 
...
!-----------------------------------------------------------------
      ...
      integer, parameter :: ncols=600, nrows=300  !** 0.125 
      integer, parameter :: NLDAS = ncols * nrows     !** map to 1D 
      real, parameter :: xres = 1/10.0          !** 5km res
      real, parameter :: yres = 1/10.0
...
!LON set to -130.05 -70.15
!LAT set to 20.75 50.65
!*** FOR 1/10 degree IMERG grid 
        NKGDSO(1)=0
        NKGDSO(2)=ncols
        NKGDSO(3)=nrows
        NKGDSO(4)=20750
