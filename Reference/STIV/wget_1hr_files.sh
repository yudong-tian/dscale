...
###  E.g.,
###   wget ftp://128.117.82.216/pub/download/data/krist17335/ST4.2004012113.01h.Z

     file=ST4.${year}${month}${day}${hour}.01h

#     if [ ${year} -ge "2014" ]; then
     if [ ${year} -ge "2013" ]; then
       wget ${ftppath}/${file}.gz -o st4_1hrfiles.log
       gunzip  ${file}.gz
     else
       wget ${ftppath}/${file}.Z -o st4_1hrfiles.log
       gunzip  ${file}.Z
     fi
