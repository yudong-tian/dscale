...
libpath="$HOME/lib"
echo $libpath
ifort -g -convert big_endian -assume byterecl -o 4km-0.25-daily-0.125_grid 4km-0.25-daily-0.125_grid.F90 $libpath/iplib_64 $libpath/w3lib.a $libpath/libbacio.a
